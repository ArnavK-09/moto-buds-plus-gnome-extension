...
export const DevicePopup = GObject.registerClass({
    ...
    _buildPlaceholder() {
        ...
        header.add_child(new St.Label({text: 'Not connected', style_class: 'mbp-header-name',
        ...
        const settingsBtn = new St.Button({label: 'Settings', style_class: 'button mbp-settings-btn',
