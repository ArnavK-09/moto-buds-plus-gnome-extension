...
export const DevicePopup = GObject.registerClass(
  ...
  class DevicePopup extends GObject.Object {
    ...
    _build() {
      ...
      this._audioTitle = new SectionTitle("Audio");
      this._content.add_child(this._audioTitle);
    ...
    _update() {
      ...
      if (s.connected && !s.synced)
        this._audioTitle.text = "Audio (Syncing...)";
      else if (this._audioTitle) this._audioTitle.text = "Audio";
    }
